...
|[python/cpython](https://github.com/python/cpython)|[gh-74028: `concurrent.futures.Executor`: avoid reference cycles when an exception is raised](https://github.com/python/cpython/pull/131701)|⚙️ wip|
